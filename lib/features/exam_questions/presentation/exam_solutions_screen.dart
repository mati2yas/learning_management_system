                  ...
                  itemBuilder: (_, index) {
                    ...
                    SizedBox(
                      ...
                      child: PageView.builder(
                        ...
                        itemCount: widget.answerHolders.length,
                        itemBuilder: (_, index) {
                          final currentAnswerHolder =
                              widget.answerHolders[index];
                          final currentQuestion =
                              widget.questions.where((question) {
                            return question.id ==
                                currentAnswerHolder.questionId;
                          }).first;
                          ...
                          for (var ans in currentAnswerHolder.correctAnswers) {
                            ...
                            if (answerIndex != -1 &&
                                answerIndex < answerLetters.length) {
                              correctAnswerText
