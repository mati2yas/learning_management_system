...
List<Question> chemistryChapterOneGrade10 = [
  ...
  Question(
    ...
    answer: "0.086 moles",
    explanation: "The number of moles is calculated using:"
        "Moles=MassMolar MassMoles=Molar MassMass​"
  ...
  Question(
    ...
    answer: "48.00 g",
    explanation: "1 mole of KClO3KClO3​ produces 3223​ moles of O2O2​."
        "Moles of KClO3KClO3​:"
        "Moles=122.55122.55=1 mol.Moles=122.55122.55​=1mol."
        "Moles of O2O2​:"
        "1×32=1.5 mol.1×23​=1.5mol."
        "Mass of O2O2​:"
        "1.5×32.00=48.00 g.1.5×32.00=48.00g.",
  ),
];
...
List<Question> chemistryChapterTwoGrade10 = [
  ...
  Question(
    ...
    explanation:
        "Butane (C4H10C4​H10​) shows structural isomerism because it can exist as two different structures: nn-butane (a straight chain) and isobutane (a branched chain). Geometric and optical isomerism occur in compounds with specific spatial arrangements, which are not applicable here.",
  ),
];
...
List<Question> mathChapterOneGrade10 = [
  Question(
    ...
    options: [
      ...
      "Every element of B has exactly one preimage in A",
      "None of the above",
    ],
  ...
  Question(
    ...
    options: [
      ...
      "f−1(x)=3x−4",
      "f−1(x)=x−43f−1(x)=3x−4​",
      "f−1(x)=x2+4f−1(x)=x2+4",
    ],
    answer: "f−1(x)=x+43f−1(x)=3x+4​",
    explanation: "To find the inverse, solve y=3x−4y=3x−4 for xx:"
        "y+4=3xy+4=3x   ⟹  x=y+43⟹x=3y+4​."
...
List<Question> mathChapterTwoGrade10 = [
  ...
  Question(
    ...
    answer: "x=2",
    explanation: " A root of f(x) satisfies f(x)=0. Substituting x=2 into f(x):"
        "f(2)=23−4(22)+6(2)−24=8−16+12−24=0f(2)=23−4(22)+6(2)−24=8−16+12−24=0."
  ...
  Question(
    ...
    options: [
      ...
      "The polynomial has one repeated real root.",
      "None of these",
    ],
    answer: "The polynomial has one repeated real root.",
    explanation:
  ...
  Question(
    ...
    answer: "f(x)→−∞ as x→∞x→∞, and f(x)→−∞f(x)→−∞ as x→−∞x→−∞.",
    explanation:
        "The leading term −2x4−2x4 determines the end behavior. Since the degree is even and the leading coefficient is negative, f(x)→−∞f(x)→−∞ as x→±∞x→±∞.",
  ),
];
